...
Following the next episode 13-B we are spliting the Backend and Frontend into two separeted projects to take the advantage of Heroku's CI/CD that basicly deploy your code automaticaly when detects a new code into your github repository.
